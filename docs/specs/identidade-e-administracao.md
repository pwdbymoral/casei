...
- [x] Perfil e preferências permitem editar nome/locale/ocultação de valores, iniciar reverificação de e-mail e senha e, para owner, editar nome/fuso/margem de segurança do espaço com prévia, `If-Match` e bloqueio de mudança de moeda após movimentos, compromissos ou cadastro de cartão.
