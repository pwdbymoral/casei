...
- Valores monetários são persistidos em unidades inteiras da menor denominação; o MVP usa uma moeda configurada por espaço e inicia com BRL. A moeda pode ser alterada somente enquanto o espaço não tiver movimentos, compromissos, cartões ou metas/reservas cadastrados; depois disso permanece imutável.
