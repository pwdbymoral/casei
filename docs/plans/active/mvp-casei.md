...
- [x] **DATA-006 UI import/export:** jornada de upload, mapeamento, prévia, stepper, progresso, resultado por linha, retry, cancelamento idempotente, exportação e relatório acessível; upload/preflight e exportação server-side permanecem dependentes das rotas de API correspondentes.
