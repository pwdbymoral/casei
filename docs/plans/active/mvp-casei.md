...
- [ ] **DATA-006 UI import/export:** a jornada web está implementada em PR separado; este boundary expõe contratos/rotas e preflight server-side, mas o bootstrap persistente de export jobs e a composição de adapters de produção ainda são pendentes.
