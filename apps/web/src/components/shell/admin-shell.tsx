...
type AdminShellProps = { children: ReactNode; displayName: string; platformRole: PlatformRole };

const AdminPlatformRoleContext = createContext<PlatformRole | null>(null);

export function useAdminPlatformRole(): PlatformRole | null {
  return useContext(AdminPlatformRoleContext);
}
...
export function AdminShell({ children, displayName, platformRole }: AdminShellProps) {
  const pathname = usePathname();
  return (
    <AdminPlatformRoleContext.Provider value={platformRole}>
    ...
    </AdminPlatformRoleContext.Provider>
  );
}
