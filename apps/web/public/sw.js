(() => {
  ...
  let e,
    ...
    n = (e) => {
      let t;
      return (
        e || ((t = i.runtime), [i.prefix, t, i.suffix].filter((e) => e && e.length > 0).join("-"))
      );
    };
  ...
  async function u(e, t, a, s) {
    ...
    for (let n of await e.keys(t, i)) if (r === h(n.url, a)) return e.match(n, s);
  }
  var d = class {
    promise;
    resolve;
    ...
    let t = (function (e) {
      if ("function" == typeof e)
        return (
          ...
          ? function (...t) {
              return e.apply(v(this), t), _(this.request);
            }
          : function (...t) {
              return _(e.apply(v(this), t));
            };
      ...
      m(e, a || (a = [IDBDatabase, IDBObjectStore, IDBIndex, IDBCursor, IDBTransaction])))
        ? new Proxy(e, y)
        : e;
    })(e);
  ...
  let v = (e) => g.get(e);
  function b(e, t, { blocked: a, upgrade: s, blocking: r, terminated: i } = {}) {
    let n = indexedDB.open(e, t),
      c = _(n);
    return (
      s &&
        n.addEventListener("upgradeneeded", (e) => {
          s(_(n.result), e.oldVersion, e.newVersion, _(n.transaction), e);
        }),
  ...
  function q(e, t) {
    ...
    let a = t.replace(/FromIndex$/, ""),
      s = t !== a,
      r = E.includes(a);
    if (!(a in (s ? IDBIndex : IDBObjectStore).prototype) || !(r || x.includes(a))) return;
  ...
  async function* P(...e) {
    ...
    let a = new Proxy(t, T);
    for (k.set(a, t), g.set(a, v(t)); t; )
      yield a, (t = await (D.get(a) || t.continue())), D.delete(a);
  }
  function N(e, t) {
    return (
  ...
  y = {
    ...(t = y),
    get: (e, a, s) => (N(e, a) ? P : t.get(e, a, s)),
    has: (e, a) => N(e, a) || t.has(e, a),
  };
  let A = {
  ...
  var I = class {
      ...
      async cachePut(e, t) {
        ...
        let { cacheName: i, matchOptions: n } = this._strategy,
          ...
          d = h ? await u(l, s.clone(), ["__WB_REVISION__"], n) : null;
        try {
      ...
      async getCacheKey(e, t) {
        ...
        if (!this._cacheKeys[a]) {
          ...
          for (let e of this.iterateCallbacks("cacheKeyWillBeUsed"))
            s = U(await e({ mode: t, request: s, event: this.event, params: this.params }));
          this._cacheKeys[a] = s;
        }
    ...
    F = class extends L {
      ...
      constructor(e = {}) {
        super(e),
          this.plugins.some((e) => "cacheWillUpdate" in e) || this.plugins.unshift(A),
  ...
  var W = class {
      ...
      _upgradeDb(e) {
        let t = e.createObjectStore(O, { keyPath: "id" });
      ...
      async setTimestamp(e, t) {
        ...
        let a = { id: this._getId(e), cacheName: this._cacheName, url: e, timestamp: t },
          s = (await this.getDb()).transaction(O, "readwrite", { durability: "relaxed" });
        await s.store.put(a), await s.done;
      }
      async getTimestamp(e) {
        return (await (await this.getDb()).get(O, this._getId(e)))?.timestamp;
      }
      async expireEntries(e, t) {
        ...
        for (; a; ) {
          ...
          i.cacheName === this._cacheName &&
            ((e && i.timestamp < e) || (t && r >= t) ? (a.delete(), s.push(i.url)) : r++),
            (a = await a.continue());
        }
        return s;
      }
      async getDb() {
        return (
          this._db ||
            (this._db = await b("serwist-expiration", 1, {
    ...
    j = class {
      ...
      _getCacheExpiration(e) {
        if (e === n()) throw new c("expire-custom-caches-only");
        let t = this._cacheExpirations.get(e);
        return t || ((t = new B(e, this._config)), this._cacheExpirations.set(e, t)), t;
      }
  ...
  let $ = async (e, t) => {
    try {
      ...
      if (!a) throw new c("no-range-header");
      let s = ((e) => {
          let t = e.trim().toLowerCase();
          if (!t.startsWith("bytes="))
            throw new c("unit-must-be-bytes", { normalizedRangeHeader: t });
          if (t.includes(",")) throw new c("single-range-only", { normalizedRangeHeader: t });
          let a = /(\d*)-(\d*)/.exec(t);
          if (!a || !(a[1] || a[2]))
        ...
        i = ((e, t, a) => {
          let s,
            ...
            i = e.size;
          if ((a && a > i) || (t && t < 0))
            throw new c("range-not-satisfiable", { size: i, end: a, start: t });
          return (
            void 0 !== t && void 0 !== a
              ? ((s = t), (r = a + 1))
              : void 0 !== t && void 0 === a
        ...
        o = n.size,
        l = new Response(n, { status: 206, statusText: "Partial Content", headers: t.headers });
      return (
  ...
  var H = class {
    ...
    Q = class extends L {
      constructor(e = {}) {
        super(e), this.plugins.some((e) => "cacheWillUpdate" in e) || this.plugins.unshift(A);
      }
      async _handle(e, t) {
        let a,
  ...
  let V = [
      {
        ...
        handler: new G({
          ...
          plugins: [new j({ maxEntries: 4, maxAgeSeconds: 31536e3, maxAgeFrom: "last-used" })],
        }),
      },
      {
        ...
        handler: new Q({
          ...
          plugins: [new j({ maxEntries: 4, maxAgeSeconds: 604800, maxAgeFrom: "last-used" })],
        }),
      },
      {
      ...
      },
      {
        ...
        handler: new Q({
          ...
          plugins: [new j({ maxEntries: 64, maxAgeSeconds: 2592e3, maxAgeFrom: "last-used" })],
        }),
      },
      {
        ...
        handler: new G({
          ...
          plugins: [new j({ maxEntries: 64, maxAgeSeconds: 86400, maxAgeFrom: "last-used" })],
        }),
      },
      {
      ...
      },
      {
        ...
        handler: new G({
          ...
          plugins: [
            new j({ maxEntries: 32, maxAgeSeconds: 86400, maxAgeFrom: "last-used" }),
            new H(),
          ],
        }),
      },
      ...
      },
      {
        ...
        handler: new Q({
          ...
          plugins: [new j({ maxEntries: 48, maxAgeSeconds: 86400, maxAgeFrom: "last-used" })],
        }),
      },
      {
        matcher: /\.(?:css|less)$/i,
        handler: new Q({
          ...
          plugins: [new j({ maxEntries: 32, maxAgeSeconds: 86400, maxAgeFrom: "last-used" })],
        }),
      },
      {
      ...
      { matcher: /\/api\/auth\/.*/, handler: new M({ networkTimeoutSeconds: 10 }) },
      {
        matcher: ({ sameOrigin: e, url: { pathname: t } }) => e && t.startsWith("/api/"),
        method: "GET",
        handler: new F({
          cacheName: "apis",
          plugins: [new j({ maxEntries: 16, maxAgeSeconds: 86400, maxAgeFrom: "last-used" })],
      ...
      },
      {
        ...
        handler: new F({
          ...
          plugins: [new j({ maxEntries: 32, maxAgeSeconds: 86400 })],
        }),
      },
      {
        matcher: ({ request: e, url: { pathname: t }, sameOrigin: a }) =>
      ...
      },
      {
        ...
        handler: new F({
          ...
          plugins: [new j({ maxEntries: 32, maxAgeSeconds: 3600 })],
          networkTimeoutSeconds: 10,
        }),
      },
      { matcher: /.*/i, method: "GET", handler: new M() },
    ],
    z = {
      googleAnalytics: "googleAnalytics",
      precache: "precache-v2",
    ...
    J = (e) => [z.prefix, e, z.suffix].filter((e) => e && e.length > 0).join("-"),
    X = (e) => e || J(z.precache);
  ...
  async function ea(e, t, a, s) {
    let r = et(t.url, a);
    if (t.url === r) return e.match(t, s);
    let i = { ...s, ignoreSearch: !0 };
    for (let n of await e.keys(t, i)) if (r === et(n.url, a)) return e.match(n, s);
  }
  var es = class {
    promise;
    resolve;
  ...
  let er = async () => {
    ...
    eo = async (e, t) => {
      ...
      if ((e.url && (a = new URL(e.url).origin), a !== self.location.origin))
        throw new Y("cross-origin-copy-response", { origin: a });
      let s = e.clone(),
        i = { headers: new Headers(s.headers), status: s.status, statusText: s.statusText },
        n = t ? t(i) : i,
        c = !(function () {
          if (void 0 === r) {
            let e = new Response("");
  ...
  var eu = class {
      _db = null;
      async addEntry(e) {
        let t = (await this.getDb()).transaction(el, "readwrite", { durability: "relaxed" });
        await t.store.add(e), await t.done;
      }
      async getFirstEntryId() {
        return (await (await this.getDb()).transaction(el).store.openCursor())?.value.id;
      }
      async getAllEntriesByQueueName(e) {
        return (await (await this.getDb()).getAllFromIndex(el, eh, IDBKeyRange.only(e))) || [];
      }
      async getEntryCountByQueueName(e) {
        return (await this.getDb()).countFromIndex(el, eh, IDBKeyRange.only(e));
      }
      async deleteEntry(e) {
        await (await this.getDb()).delete(el, e);
      }
      ...
      async getEndEntryFromIndex(e, t) {
        return (await (await this.getDb()).transaction(el).store.index(eh).openCursor(e, t))?.value;
      }
      async getDb() {
        return (
          this._db ||
            (this._db = await b("serwist-background-sync", 3, { upgrade: this._upgradeDb })),
          this._db
        );
      }
      _upgradeDb(e, t) {
        t > 0 && t < 3 && e.objectStoreNames.contains(el) && e.deleteObjectStore(el),
          e
            .createObjectStore(el, { autoIncrement: !0, keyPath: "id" })
            .createIndex(eh, eh, { unique: !1 });
      }
    },
    ed = class {
      _queueName;
      _queueDb;
      constructor(e) {
        (this._queueName = e), (this._queueDb = new eu());
      }
      async pushEntry(e) {
  ...
  let ew = "serwist-background-sync",
    ep = new Set(),
    eg = (e) => {
      let t = { request: new em(e.requestData).toRequest(), timestamp: e.timestamp };
  ...
  var ey = class {
      ...
      async getAll() {
        ...
        for (let s of e) {
          ...
          t - s.timestamp > e ? await this._queueStore.deleteEntry(s.id) : a.push(eg(s));
        }
        return a;
      }
      async size() {
      ...
      async _addRequest({ request: e, metadata: t, timestamp: a = Date.now() }, s) {
        let r = { requestData: (await em.fromRequest(e.clone())).toObject(), timestamp: a };
      ...
      async _removeRequest(e) {
        ...
        if (t) {
          ...
          return a - t.timestamp > s ? this._removeRequest(e) : eg(t);
        }
      }
      async replayRequests() {
        ...
        for (; (e = await this.shiftRequest()); )
          try {
            ...
            throw (
              (await this.unshiftRequest(e), new Y("queue-replay-failed", { name: this._name }))
            );
          }
      }
      async registerSync() {
        if ("sync" in self.registration && !this._forceSyncFallback)
          try {
            await self.registration.sync.register(`${ew}:${this._name}`);
          } catch (e) {}
      }
      _addSyncListener() {
        "sync" in self.registration && !this._forceSyncFallback
          ? self.addEventListener("sync", (e) => {
              if (e.tag === `${ew}:${this._name}`) {
                let t = async () => {
                  let t;
  ...
  var ex = class {
      ...
      async fetch(e) {
        ...
        try {
          ...
          if (e instanceof Error)
            throw new Y("plugin-error-request-will-fetch", { thrownErrorMessage: e.message });
        }
        let i = a.clone();
        try {
          let e;
      ...
      async cachePut(e, t) {
        ...
        let { cacheName: i, matchOptions: n } = this._strategy,
          ...
          l = o ? await ea(c, s.clone(), ["__WB_REVISION__"], n) : null;
        try {
          await c.put(s, o ? r.clone() : r);
        } catch (e) {
          if (e instanceof Error) throw ("QuotaExceededError" === e.name && (await er()), e);
        }
        for (let e of this.iterateCallbacks("cacheDidUpdate"))
          await e({
            cacheName: i,
    ...
    eE = class {
      ...
      matchOptions;
      constructor(e = {}) {
        (this.cacheName = ((e) => e || J(z.runtime))(e.cacheName)),
          (this.plugins = e.plugins || []),
          (this.fetchOptions = e.fetchOptions),
          (this.matchOptions = e.matchOptions);
      }
      ...
      async _getResponse(e, t, a) {
        ...
        try {
          if (((s = await this._handle(t, e)), void 0 === s || "error" === s.type))
            throw new Y("no-response", { url: t.url });
        } catch (r) {
          if (r instanceof Error) {
            for (let i of e.iterateCallbacks("handlerDidError"))
              if (void 0 !== (s = await i({ error: r, event: a, request: t }))) break;
    ...
    eR = class extends eE {
      ...
      constructor(e = {}) {
        super(e),
          this.plugins.some((e) => "cacheWillUpdate" in e) || this.plugins.unshift(ev),
          (this._networkTimeoutSeconds = e.networkTimeoutSeconds || 0);
      }
      async _handle(e, t) {
        let a,
        ...
        if (!n) throw new Y("no-response", { url: e.url });
        return n;
      }
      _getTimeoutPromise({ request: e, logs: t, handler: a }) {
        let s;
    ...
    eq = class extends eE {
      ...
      async _handle(e, t) {
        ...
        try {
          let a = [t.fetch(e)];
          if (this._networkTimeoutSeconds) {
            let e = Z(1e3 * this._networkTimeoutSeconds);
            a.push(e);
          }
          if (!(s = await Promise.race(a)))
            throw Error(
        ...
        if (!s) throw new Y("no-response", { url: e.url, error: a });
        return s;
      }
    };
  let eS = (e) => (e && "object" == typeof e ? e : { handle: e });
  var eC = class {
      handler;
      match;
      method;
      ...
      constructor(e, t, a = "GET") {
        (this.handler = eS(t)), (this.match = e), (this.method = a);
      }
      setCatchHandler(e) {
        this.catchHandler = eS(e);
      }
    },
    eD = class e extends eE {
      _fallbackToNetwork;
      static defaultPrecacheCacheabilityPlugin = {
        cacheWillUpdate: async ({ response: e }) => (!e || e.status >= 400 ? null : e),
      };
      static copyRedirectedCacheableResponsesPlugin = {
        cacheWillUpdate: async ({ response: e }) => (e.redirected ? await eo(e) : e),
      };
      constructor(t = {}) {
        (t.cacheName = X(t.cacheName)),
          super(t),
      ...
      async _handleFetch(e, t) {
        ...
        } else throw new Y("missing-precache-entry", { cacheName: this.cacheName, url: e.url });
        return a;
      }
      async _handleInstall(e, t) {
        ...
        if (!(await t.cachePut(e, a.clone())))
          throw new Y("bad-precaching-response", { url: e.url, status: a.status });
        return a;
      }
  ...
  let eP = (e) => {
    ...
    if (!a) throw new Y("add-to-cache-list-unexpected-type", { entry: e });
    if (!t) {
  ...
  "u" > typeof navigator && /^((?!chrome|android).)*safari/i.test(navigator.userAgent);
  let eU = /^\/(\w+\/)?collect/,
    eI = ({ serwist: e, cacheName: t, ...a }) => {
      let s,
        r,
        i = t || J(z.googleAnalytics),
        n = new e_("serwist-google-analytics", {
            ...
            for (; (t = await e.shiftRequest()); ) {
              ...
              try {
                let e =
                  ...
                  n = Date.now() - t;
                if ((e.set("qt", String(n)), a.parameterOverrides))
      ...
      for (let t of [
        ...
        new eC(
          (s = ({ url: e }) => "www.google-analytics.com" === e.hostname && eU.test(e.pathname)),
          (r = new eq({ plugins: [n] })),
          "GET",
        ),
        new eC(s, r, "POST"),
  ...
  new (class {
    ...
    constructor({
      ...
      if (
        ...
        m.cleanupOutdatedCaches &&
          ((e) => {
            self.addEventListener("activate", (t) => {
              t.waitUntil(en(X(e)).then((e) => {}));
            });
          })(d.cacheName),
        this.registerRoute(new eF(this, f)),
        m.navigateFallback &&
          this.registerRoute(
            new ek(this.createHandlerBoundToUrl(m.navigateFallback), {
              allowlist: m.navigateFallbackAllowlist,
              denylist: m.navigateFallbackDenylist,
            }),
          ),
        void 0 !== o &&
          ("boolean" == typeof o ? o && eI({ serwist: this }) : eI({ ...o, serwist: this })),
        void 0 !== c)
      ) {
        if (void 0 !== h) {
          const e = new eL({ fallbackUrls: h.entries, serwist: this });
          c.forEach((t) => {
            t.handler instanceof eE &&
      ...
      for (let a of e) {
        ...
        if ("string" != typeof a && a.integrity) {
          if (
            ...
            throw new Y("add-to-cache-list-conflicting-integrities", { url: s });
...
This is generally NOT safe. Learn more at https://bit.ly/wb-precache`);
    ...
    setDefaultHandler(e, t = "GET") {
      this._defaultHandlerMap.set(t, eS(e));
    }
    setCatchHandler(e) {
      this._catchHandler = eS(e);
    }
    registerCapture(e, t, a) {
      let s = ((e, t, a) => {
        if ("string" == typeof e) {
          let s = new URL(e, location.href);
          return new eC(({ url: e }) => e.href === s.href, t, a);
        }
        if (e instanceof RegExp) return new eT(e, t, a);
        if ("function" == typeof e) return new eC(e, t, a);
    ...
    unregisterRoute(e) {
      if (!this._routes.has(e.method))
        throw new Y("unregister-route-but-not-found-with-method", { method: e.method });
      let t = this._routes.get(e.method).indexOf(e);
      if (t > -1) this._routes.get(e.method).splice(t, 1);
      else throw new Y("unregister-route-route-not-registered");
    }
    ...
    createHandlerBoundToUrl(e) {
      ...
      if (!t) throw new Y("non-precached-url", { url: e });
      return (a) => (
    ...
    precacheEntries: [
      {
        revision: "c870b219f06c6c6e17f1960ae96e73dc",
        url: "/_next/static/GK4BNlhZvucKVsKmhqO_O/_buildManifest.js",
      },
      {
        revision: "b6652df95db52feb4daf4eca35380933",
        url: "/_next/static/GK4BNlhZvucKVsKmhqO_O/_ssgManifest.js",
      },
      { revision: null, url: "/_next/static/chunks/75-fd1d330e57846a81.js" },
      { revision: null, url: "/_next/static/chunks/app/_global-error/page-fee460aad217f4b8.js" },
      { revision: null, url: "/_next/static/chunks/app/_not-found/page-4170388c72250aab.js" },
      { revision: null, url: "/_next/static/chunks/app/layout-c2e636fbab326065.js" },
      {
        revision: null,
        url: "/_next/static/chunks/app/manifest.webmanifest/route-fee460aad217f4b8.js",
      },
      { revision: null, url: "/_next/static/chunks/app/page-c31ce04617a2a729.js" },
      { revision: null, url: "/_next/static/chunks/b67d1f1d-f0768b609eb5f289.js" },
      { revision: null, url: "/_next/static/chunks/framework-7f81f50a798194b6.js" },
      { revision: null, url: "/_next/static/chunks/main-1d459e81e219a732.js" },
      { revision: null, url: "/_next/static/chunks/main-app-be8d70f57540a074.js" },
      {
        revision: null,
        url: "/_next/static/chunks/next/dist/client/components/builtin/app-error-fee460aad217f4b8.js",
      },
      {
        revision: null,
        url: "/_next/static/chunks/next/dist/client/components/builtin/forbidden-fee460aad217f4b8.js",
      },
      {
        revision: null,
        url: "/_next/static/chunks/next/dist/client/components/builtin/global-error-5d87c73b156f9251.js",
      },
      {
        revision: null,
        url: "/_next/static/chunks/next/dist/client/components/builtin/not-found-fee460aad217f4b8.js",
      },
      {
        revision: null,
        url: "/_next/static/chunks/next/dist/client/components/builtin/unauthorized-fee460aad217f4b8.js",
      },
      {
        revision: "846118c33b2c0e922d7b3a7676f81f6f",
        url: "/_next/static/chunks/polyfills-42372ed130431b0a.js",
      },
      { revision: null, url: "/_next/static/chunks/webpack-efff8d5f9816e10f.js" },
      { revision: null, url: "/_next/static/css/1fbf074b0d2746f2.css" },
      {
      ...
      { revision: "43b78742d57130f43e417bfbc939f8c6", url: "/icon-1024.png" },
